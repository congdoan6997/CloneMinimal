...
export default function ComingSoonView() {
  ...
  return <>
    ...
    <Stack direction="row" justifyContent="center" divider={<Box sx={{mx:{sx: 1, md: 2.5}}}>:</Box>} sx={{typography: 'h2'}}>
    ...
    <TextField fullWidth placeholder="Enter your email" InputProps={{
      endAdornment: (
        <InputAdornment position="end">
          <Button variant="contained" size="large">Notify Me</Button>
        </InputAdornment>
      ),
      sx: {
        pr: 0.5
    ...
    <Stack spacing={1} alignItems="center" justifyContent="center" direction="row">
      {_socials.map((social) => (
        <IconButton key={social.name} sx={{color: social.color,'&:hover': {bgcolor: alpha(social.color, 0.08)} }}>
